...
import { IoShieldHalfOutline,  IoMailOutline, IoLockClosedOutline, IoPersonOutline } from "react-icons/io5";
  ...
  return (
    <>
      ...
      <div className="h-screen w-screen flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-black via-slate-950 to-slate-900">
        ...
        {/* Content */}
        <div className="relative z-10 w-full max-w-sm px-6 flex flex-col justify-center min-h-screen py-4">
          {/* Logo Section */}
          <div className="flex items-center justify-center mb-4 logo-container">
            <IoShieldHalfOutline className='text-4xl text-blue-300 drop-shadow-lg' />
            <p className='bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-300 bg-clip-text text-transparent text-2xl font-bold ml-2'>
              Xyber Kavach
            </p>
          </div>

          {/* Signup Form */}
          <div className="form-container bg-slate-900/40 backdrop-blur-md p-5 rounded-3xl shadow-2xl signup-form w-full max-w-sm mx-auto">
            ...
            <form className="space-y-3" onSubmit={handleSubmit}>
              ...
              <div className="input-group">
                <div className="relative">
                  <IoPersonOutline className="absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-400 text-lg" />
                  <input
                    type="text"
              ...
              <div className="input-group">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="input-field w-full pl-12 pr-12 py-2.5 rounded-xl bg-slate-800/50 border border-slate-700/50 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:bg-slate-800/80"
                  />
              ...
              <button
              type="submit"
                className="signup-button w-full py-2.5 text-white font-semibold rounded-xl relative overflow-hidden block text-center"
              >
